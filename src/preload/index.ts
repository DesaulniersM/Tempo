...
const api = {
  ...
  addCategory: (name: string, color: string) => electronAPI.ipcRenderer.invoke('db:addCategory', name, color),
  updateCategory: (id: number, name: string, color: string, weeklyTarget: number, dailyTarget: number) => electronAPI.ipcRenderer.invoke('db:updateCategory', id, name, color, weeklyTarget, dailyTarget),
